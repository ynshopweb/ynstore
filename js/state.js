...
export const INITIAL_PRODUCTS = [
    { id: 'p1', name: 'Skintific 5X Ceramide Barrier Moisturizer', brand: 'Skintific', category: 'Moisturizer', price: 139000, originalPrice: 169000, rating: 4.9, sales: 340, isBestseller: true, isNew: false, image: 'https://images.unsplash.com/photo-1608248597261-8332570543a8?w=500&auto=format&fit=crop&q=80', description: 'Moisturizer yang menggabungkan 3 kandungan aktif Ceramide, Hyaluronic Acid, dan Centella Asiatica.', stock: 25 },
