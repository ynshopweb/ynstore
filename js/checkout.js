        ...
        window.renderTimeSlots = function() {
            ...
            if (container) {
                container.innerHTML = slots.map(s => `
                    <button type="button" onclick="selectTimeSlot('${s}', this)" class="slot-btn border border-slate-200 rounded-lg p-2 text-[11px] font-semibold text-slate-700 hover:border-brand-500 hover:bg-rose-50 transition">
                        ${s} WIB
                    </button>
                `).join('');
            }
